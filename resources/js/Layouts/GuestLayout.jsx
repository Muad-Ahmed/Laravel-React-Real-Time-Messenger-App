                            ...
                            <div className="flex-1">
                                ...
                                <div className="space-y-3.5">
                                    <div className="group">
                                        ...
                                        <code className="block p-3 rounded-xl bg-white/90 dark:bg-slate-900/90 text-sm sm:text-base font-bold text-indigo-500 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/50 shadow-sm group-hover:border-indigo-300 transition-all tracking-wide break-all">
                                    ...
                                    <div className="group">
                                        ...
                                        <code className="block p-3 rounded-xl bg-white/90 dark:bg-slate-900/90 text-sm sm:text-base font-bold text-indigo-500 dark:text-indigo-300 border border-indigo-100 dark:border-indigo-900/50 shadow-sm group-hover:border-indigo-300 transition-all tracking-wide">
                                            secret_token_99
                                        </code>
                                    </div>
                                </div>
